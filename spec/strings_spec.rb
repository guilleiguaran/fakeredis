...
module FakeRedis
  describe "StringsMethods" do
    ...
    it "should set multiple keys to multiple values, only if none of the keys exist" do
      @client.msetnx(:key1, "value1", :key2, "value2").should == true
      @client.msetnx(:key1, "value3", :key2, "value4").should == false
    ...
    it "should set multiple keys to multiple values with a hash, only if none of the keys exist" do
      @client.mapped_msetnx(:key1 => "value1", :key2 => "value2").should == true
      @client.mapped_msetnx(:key1 => "value3", :key2 => "value4").should == false
