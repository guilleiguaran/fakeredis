  ...
  describe "SortedSetsMethods" do
    ...
    describe "#zunionstore" do
      ...
      it "should union two keys with custom scores" do
        ...
        @client.zrange("out", 0, -1, :with_scores => true).should == ["val1", "1", "val2", (2 + 5).to_s, "val3", (3 + 7).to_s]
      end

      it "should union two keys with a default score" do
        @client.zunionstore("out", %w(key1 key3)).should == 3
        @client.zrange("out", 0, -1, :with_scores => true).should == ["val1", (1 + 1).to_s, "val2", (2 + 1).to_s, "val3", "3"]
      end

      it "should union more than two keys" do
        @client.zunionstore("out", %w(key1 key2 key3)).should == 3
        @client.zrange("out", 0, -1, :with_scores => true).should == ["val1", (1 + 1).to_s, "val2", (2 + 5 + 1).to_s, "val3", (3 + 7).to_s]
      end
      ...
      it "should union two keys with weighted values" do
        ...
        @client.zrange("out", 0, -1, :with_scores => true).should == ["val1", (1 * 10).to_s, "val2", (2 * 10 + 5).to_s, "val3", (3 * 10 + 7).to_s]
      end
      ...
      it "should union two keys with weighted minimum values" do
        ...
        @client.zrange("out", 0, -1, :with_scores => true).should == ["val2", "5", "val3", "7", "val1", (1 * 10).to_s]
      end
      ...
      it "should union two keys with weighted maximum values" do
        ...
        @client.zrange("out", 0, -1, :with_scores => true).should == ["val1", (1 * 10).to_s, "val2", (2 * 10).to_s, "val3", (3 * 10).to_s]
      end
